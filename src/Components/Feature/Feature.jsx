    ...
    <div id='feature-content' className={isVisible ? 'visible' : ''}>
      ...
      <div className="row1-container">
        <div className="box box-down cyan">
          ...
          <img src="/public/assets//realtime.svg" alt="Supervisor Icon" />
        </div>
        <div className="box red">
          ...
          <img src="/public/assets//geofencing.png" alt="Team Builder Icon" />
        </div>
        <div className="box box-down blue">
          ...
          <img src="/public/assets//estimated.png" alt="Calculator Icon" />
        </div>
      </div>
      <div className="row2-container">
        <div className="box orange">
          ...
          <img src="/public/assets//customizable.svg" alt="Karma Icon" />
        </div>
      </div>
    </div>
  );
