...
const Cards = () => {
  return (
    ...
    <div className="cards">
      <div className="card">
        <img className="card-image" src="/src/assets/admin-img.jpg" alt="Card Image" />
      ...
      <div className="card">
        <img className="card-image" src="/src/assets/student-img.svg" alt="Card Image" />
        <div className="card-content">
      ...
      <div className="card">
        <img className="card-image" src="/src/assets/driver-img.svg" alt="Card Image" />
        <div className="card-content">
